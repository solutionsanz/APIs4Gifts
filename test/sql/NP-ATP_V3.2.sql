...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "GIFTS_ADMIN"."GAME_OBJECTS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "GIFTS_ADMIN"."GAME_PLAYERS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;

--------------------------------------------------------
--  DDL for Sequence GAMES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "GIFTS_ADMIN"."GAMES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
  
--------------------------------------------------------
--  DDL for Sequence GAME_PLAYER_INTERACTIONS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "GIFTS_ADMIN"."GAME_PLAYER_INTERACTIONS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;

   
CREATE TABLE "GIFTS_ADMIN"."GAMES" (
    "GAME_ID"     NUMBER(3,0)
        NOT NULL ENABLE,
...
CREATE OR REPLACE EDITIONABLE TRIGGER "GIFTS_ADMIN"."GAMES_TRG" BEFORE
    INSERT ON games
    FOR EACH ROW
BEGIN
...
ALTER TRIGGER "GIFTS_ADMIN"."GAMES_TRG" ENABLE;

CREATE TABLE "GIFTS_ADMIN"."GAME_OBJECTS" (
...
CREATE OR REPLACE EDITIONABLE TRIGGER "GIFTS_ADMIN"."GAME_OBJECTS_TRG" BEFORE
...
ALTER TRIGGER "GIFTS_ADMIN"."GAME_OBJECTS_TRG" ENABLE;

CREATE TABLE "GIFTS_ADMIN"."GAME_PLAYERS" (
...
CREATE OR REPLACE EDITIONABLE TRIGGER "GIFTS_ADMIN"."GAME_PLAYERS_TRG" BEFORE
...
CREATE TABLE "GIFTS_ADMIN"."GAME_PLAYER_INTERACTIONS" (
...
CREATE OR REPLACE EDITIONABLE TRIGGER "GIFTS_ADMIN"."GAME_PLAYER_INTERACTIONS_TRG" BEFORE
...
ALTER TRIGGER "GIFTS_ADMIN"."GAME_PLAYER_INTERACTIONS_TRG" ENABLE;
